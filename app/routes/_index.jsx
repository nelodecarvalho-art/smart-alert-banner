    ...
    <div style={S.page}>
      ...
      <div style={S.card}>
        ...
        <div style={S.formGroup}>
          <label htmlFor="bannerText" style={S.label}>Banner text</label>
          <input
            id="bannerText"
            style={S.input}
            type="text"
            ...
            maxLength={200}
            aria-describedby="bannerTextCount"
          />
          <span id="bannerTextCount" style={{ fontSize: "0.78rem", color: "#999" }}>
            {settings.bannerText.length}/200 characters
          </span>
        </div>

        <div style={S.formRow}>
          <div style={S.formGroup}>
            <label htmlFor="targetState" style={S.label}>Target state</label>
            <select
              id="targetState"
              style={S.select}
        ...
        <div style={S.formRow}>
          <div style={{ ...S.formGroup, maxWidth: 220 }}>
            <label htmlFor="backgroundColor" style={S.label}>Background color</label>
          ...
          <div style={{ ...S.formGroup, maxWidth: 220 }}>
            <label htmlFor="textColor" style={S.label}>Text color</label>
            <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
              <input
                type="color"
        ...
        <button style={S.btnPrimary} onClick={save} disabled={saving} aria-busy={saving}>
      ...
      <div style={S.card}>
        ...
        <div style={S.preview} aria-label="Banner preview">
          ...
          <div
            ...
            role="img"
            aria-label="Banner appearance preview"
          >
            {settings.bannerText || "Your banner text here"}
            {settings.showState && (
              <span style={{ display: "block", fontSize: "0.8rem", opacity: 0.9, marginTop: 4 }}>
                📍 {settings.targetState} only
                {settings.deadline && " — Offer ends soon ⏰"}
              </span>
            )}
            <span aria-hidden="true" style={{ position: "absolute", right: 14, top: "50%", transform: "translateY(-50%)", opacity: 0.7, fontSize: 14 }}>✕</span>
          </div>
